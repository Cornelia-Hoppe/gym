  ...
  return (
    ...
    animate={{
        ...
        {openDesc && (
          ...
          >
            ...
            <div className="info-modal-desc">
              ...
              <p className="info-modal-text">
                Lorem ipsum dolor sit amet, consectetur blandit bibendum lectus.
                Aenean mattis eros sit amet enim molestie, bibendum elementum
                lorem maximus.
              </p>
            </div>
          </motion.div>
      ...
      <div className="modal-add-container">
        <motion.button whileTap={{ scale: 0.8 }} onClick={() => {addItemToCart()}} className="modal-add">
